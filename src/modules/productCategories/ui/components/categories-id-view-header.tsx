...
const CategoriesIdViewHeader = ({ categoryId, categoryName, onEdit, onRemove }: Props) => {
	return (
				...
				<BreadcrumbList>
					...
					<BreadcrumbItem>
						<BreadcrumbLink asChild className="text-sm font-medium text-foreground">
							<Link href={`/agents/${categoryId}`}>{categoryName}</Link>
						</BreadcrumbLink>
					</BreadcrumbItem>
				</BreadcrumbList>
			</Breadcrumb>
...
export default CategoriesIdViewHeader;
